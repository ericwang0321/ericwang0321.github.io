...
const portfolioEntries: PortfolioEntry[] = [
  ...
  {
    number: "06",
    title: { en: "LLM Inference Optimization, Illustrated", zh: "大语言模型推理优化图解" },
    excerpt: {
      ...
      zh: "一条提示词如何穿过推理系统，以及两类让它更快的方法：围绕 KV Cache 的优化，以及与 KV Cache 无关的优化。",
    },
    href: "/research/llm-inference-optimization/",
    meta: { en: "Source blog · Jul 2026", zh: "原文博客 · 2026 年 7 月" },
    sourceType: { en: "LLM INFERENCE", zh: "大语言模型推理" },
  ...
  {
    number: "07",
    title: { en: "Kimi K3: Architecture, Precision and Hardware Deployment", zh: "Kimi K3：架构、数值精度与硬件部署" },
    excerpt: {
      ...
      zh: "文本如何进入模型 → 模型如何计算 → 数据存在哪里 → 低精度为何节省 HBM → 为什么部分 GPU 或 TPU 更容易运行模型。",
    },
  ...
  {
    number: "08",
    title: { en: "The Three Layers of LLM Agents", zh: "大语言模型智能体的三层结构" },
    excerpt: {
      en: "A field guide to what each layer answers — and how they stack, not compete.",
      zh: "分别解释推理、单智能体执行和多智能体编排解决什么问题，以及三层如何叠加，而不是彼此竞争。",
    },
    ...
    sourceType: { en: "AGENT ARCHITECTURE", zh: "智能体架构" },
    kind: "deck",
    group: "technology",
  },
  {
    number: "09",
    title: { en: "Agents & Harnesses", zh: "智能体与运行框架" },
    excerpt: {
      en: "The Layered Architecture, the Recurring Patterns, and What Endures.",
      zh: "梳理生产级智能体背后的分层架构、反复出现的设计模式，以及长期有效的安全与成本控制方法。",
    },
    meta: { en: "19-page visual deck", zh: "19 页视觉讲解" },
    href: "/library/agent-harness/",
    image: "/readings/agent-harness/page-01.avif",
    sourceType: { en: "AGENT SYSTEMS", zh: "智能体系统" },
    kind: "deck",
    group: "technology",
  },
  {
    number: "10",
    title: { en: "Sandbox, Docker & Virtual Machines", zh: "沙箱、Docker 与虚拟机" },
    excerpt: {
      en: "How they really fit together for AI Agents.",
      zh: "解释沙箱、Docker 与虚拟机在 AI 智能体中的真实关系，以及它们各自提供的运行与隔离边界。",
    },
